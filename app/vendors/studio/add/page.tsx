...
const AddStudio: React.FC = () => {
    ...
    const formSchema = z.object({
        studioname: z.string().min(2, "Freelancer name must be at least 2 characters."),
    ...
    const onSubmit: SubmitHandler<StudioAdd> = async (data) => {
        setLoading(true);
        ...
        try {
            await axiosInstance.post('/studios', payload, {
                headers: {
                ...
                <CardHeader>
                    <div className="space-y-6 p-5 pb-2">
                        <div className="space-y-0.5">
                            <h2 className="text-2xl font-bold tracking-tight">Add Studio</h2>
                            <p className="text-gray-400 text-sm">
                                Fill the form and add the Studio to your list.
                            </p>
                        </div>
