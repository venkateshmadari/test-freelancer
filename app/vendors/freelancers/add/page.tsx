...
const AddFreelancer: React.FC = () => {
    ...
    const formSchema = z.object({
        ...
        username: z.string()
            ...
            .regex(/^[\w\.\-@]+$/, "Username can only contain letters, numbers, periods, hyphens, and @ symbols."),
    ...
    const onSubmit: SubmitHandler<FreelancerAdd> = async (data) => {
        ...
        try {
            await axiosInstance.post('/freelancers', payload, {
                headers: {
            ...
            toast({
                ...
                description: "Freelancer added successfully!",
                variant: 'success'
            });
                ...
                <CardHeader>
                    <div className="space-y-6 p-5 pb-2">
                        <div className="space-y-0.5">
                            <h2 className="text-2xl font-bold tracking-tight">Add Freelancer</h2>
                            <p className="text-gray-400 text-sm">
                                Fill the form and add the freelancer to your list.
                            </p>
                        </div>
