...
const Plans: React.FC = ({ params }: any) => {
  ...
  const plans = [
    {
      id: 1,
      planName: 'Wedding Photography',
      category: 'Photography',
      price: 25000.00
    },
    {
      id: 2,
      planName: 'Pre-Wedding Shoot',
      category: 'Photography',
      price: 15000.00
    },
    {
      id: 3,
      planName: 'Portrait Session',
      category: 'Photography',
      price: 8000.00
    },
    {
      id: 4,
      planName: 'Event Photography',
      category: 'Photography',
      price: 20000.00
    },
    {
      id: 5,
      planName: 'Wedding Videography',
      category: 'Videography',
      price: 30000.00
    },
    {
      id: 6,
      planName: 'Corporate Video',
      category: 'Videography',
      price: 35000.00
    },
    {
      id: 7,
      planName: 'Product Video',
      category: 'Videography',
      price: 25000.00
    },
    {
      id: 8,
      planName: 'Event Videography',
      category: 'Videography',
      price: 28000.00
    }
  ];
  ...
  const fetchGroups = async () => {
    ...
    try {
      ...
      setGroups(res.data);
      console.log("SingleGroup:", res?.data)
    } catch {
      ...
      <Card className="w-[98%]">
        <CardHeader>
          <div className='w-full h-auto flex justify-between items-center'>
            <div>
              <CardTitle className="text-lg md:text-2xl font-semibold">Plans</CardTitle>
              <CardDescription className='text-xs mt-1'>Overall 2 Groups</CardDescription>
            </div>
            <div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className='text-heading-dark dark:text-[#FACC15] font-bold'>PLAN NAME</TableHead>
                  <TableHead className='text-heading-dark dark:text-[#FACC15] font-bold'>PRICE</TableHead>
              ...
              <TableBody>
                  <TableRow>
                    ...
                    <TableCell className='font-semibold text-heading-dark dark:text-neutral-400'>Plan 1</TableCell>
