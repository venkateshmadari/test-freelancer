        ...
        setGroups((prev) =>
          prev.map((group) =>
            group.id === selectedGroupId
              ? { ...group, groupName: editGroupName, status: editGroupStatus }
              : group
          )
        );
        toast({
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="font-semibold text-heading-dark dark:text-neutral-400">
                      <Link href={`/pricing/plans/${item?.id}`}>
                        <Button variant={"default"}>Add Plans</Button>
                      </Link>
                    </TableCell>
                    <TableCell>
      ...
      <Dialog open={openEditModal} onOpenChange={setOpenEditModal}>
        <DialogContent>
          ...
          <DialogFooter className="mt-3">
            ...
            <Button type="button" onClick={handleEditGroup}>
              Update Group
            </Button>
          </DialogFooter>
        </DialogContent>
